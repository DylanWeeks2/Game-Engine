...
constexpr double Get1dNoiseZeroToOneDP(int index, unsigned int seed = 0);
...
//-----------------------------------------------------------------------------------------------
constexpr double Get1dNoiseZeroToOneDP(int index, unsigned int seed)
{
	constexpr double ONE_OVER_MAX_UINT = (1.0 / (double)0xFFFFFFFF);
	return (ONE_OVER_MAX_UINT * (double)Get1dNoiseUint(index, seed));
}
